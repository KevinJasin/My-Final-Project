<template>
  ...
  <header id="top"
    class="relative z-50 flex flex-col items-center w-full text-lg text-neutral-700 min-h-screen md:min-h-[90vh] px-5 pt-6 md:px-20 overflow-x-hidden"
  >
